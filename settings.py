...
# My own apps
    ...
    },
    {
        ...
        'mturk_hit_settings': {
            ...
            'title': '8 minutes STANFORD UNIVERSITY study: Earn up to $1.50',
            'description': 'We are conducting an academic survey on individual decision making. In the course of the study, we will ask you to make one choice. In addition to the HIT reward, you may receive $1.00 of bonus, depending on your choice and some luck.',
            'frame_height': 800,
