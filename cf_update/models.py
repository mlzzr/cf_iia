...
class Constants(BaseConstants):
    # Basics
    name_in_url = 'yliangStanfordUpdateExperiment1'
    players_per_group = None
    num_parts = 2  # cf_update and cf_predict
    ...
    numberunderstandingquestion1 = 6

    # Questions
    with open('cf_update/questions_12.csv') as f:
...
class Subsession(BaseSubsession):
    def before_session_starts(self):
        ...
        for p in self.get_players():
            ...
            p.posterior = question_data[p.ball + '1'] / (question_data[p.ball + '1'] + question_data[p.ball + '2']) * 100
...
class Player(BasePlayer):
    ...
    truefalse3 = models.BooleanField(choices=[[1, 'True'], [0, 'False']], widget=widgets.RadioSelect(),
                                     verbose_name="I can increase my chance of receiving the extra bonus if I overstate my belief about the selected box being Box A.")
